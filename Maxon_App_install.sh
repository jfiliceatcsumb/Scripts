...
# https://support.maxon.net/hc/en-us/articles/4687177301788-Scripted-Install-Instructions#RunningScriptedInstaller-Mac:.1
# 
# 
...
"${SCRIPTPATH}"/*.app/Contents/MacOS/installbuilder.sh --mode unattended --unattendedmodeui minimal --skipMaxonAppGui 1

...
# backup
security -v authorizationdb read system.preferences.energysaver > ${BackupDirectory}/${date_stamp}.system.preferences.energysaver.plist
# unlock energysaver: 
security -v authorizationdb write system.preferences.energysaver allow

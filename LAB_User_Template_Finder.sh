...
defaults write "${AdminHOME}/Library/Preferences/com.apple.LaunchServices.plist" LSHandlers -array-add '<dict><key>LSHandlerContentType</key> <string>com.apple.property-list</string> <key>LSHandlerRoleAll</key> <string>com.barebones.textwrangler</string> </dict>'
defaults write "${AdminHOME}/Library/Preferences/com.apple.LaunchServices.plist" LSHandlers -array-add '<dict><key>LSHandlerContentType</key> <string>public.shell-script</string> <key>LSHandlerRoleAll</key> <string>com.barebones.textwrangler</string> </dict>'
##########  ##########

...
#below will identify presence of any Office app version 16.53 through 16.99:
if [[ $excelversion =~ ^16.(5[3-9].*|[6-9][0-9].*) ]] || \
[[ $onenoteversion =~ ^16.(5[3-9].*|[6-9][0-9].*) ]] || \
[[ $powerpointversion =~ ^16.(5[3-9].*|[6-9][0-9].*) ]] || \
[[ $wordversion =~ ^16.(5[3-9].*|[6-9][0-9].*) ]] ;

...
#Set the run inverval to run every $AdminMinutes
# multiply by 60 to get seconds
AdminSeconds=$(expr $AdminMinutes \* 60)
sudo defaults write /Library/LaunchDaemons/removeAdmin.plist StartInterval -integer $AdminSeconds

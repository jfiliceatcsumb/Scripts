...
# This script quits and deletes existing installation of Google Drive.app (the new name of File Stream starting with version 45)
...
if [[ -d "/Applications/Google Drive.app" ]]; then
	...
	rm -fR "/Applications/Google Drive.app"
fi
